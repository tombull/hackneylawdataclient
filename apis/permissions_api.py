...
class PermissionsApi(object):
    ...
    def create_permissions(self, document, **kwargs):
        """
        Create some admin-permissions
        Create one or more admin-permissions.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_permissions(document, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param Permissions document: Create a document by sending the paths to be added in the request body. (required)
        ...
        if ('document' not in params) or (params['document'] is None):
            raise ValueError("Missing the required parameter `document` when calling `create_permissions`")

        resource_path = '/admin-permissions'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_permissions_by_id(self, id, **kwargs):
        """
        Delete a _permissions by its unique ID
        Deletes an existing _permissions by its ID.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_permissions_by_id(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_permissions_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_permissions_by_id`")

        resource_path = '/admin-permissions/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
    ...
    def delete_permissions_by_query(self, **kwargs):
        """
        Delete some admin-permissions by query
        Delete all admin-permissions matching the specified query.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_permissions_by_query(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_permissions_by_query" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        response = self.api_client.call_api(resource_path, 'DELETE',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[Permissions]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_permissions_by_id(self, id, **kwargs):
        """
        Get a _permissions by its unique ID
        Retrieve a _permissions by its ID.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_permissions_by_id(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_permissions_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_permissions_by_id`")
    ...
    def query_permissions(self, **kwargs):
        """
        Query some admin-permissions
        Query over admin-permissions.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.query_permissions(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method query_permissions" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def update_permissions(self, id, document, **kwargs):
        """
        Modify a _permissions by its unique ID
        Update an existing _permissions by its ID.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_permissions(id, document, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str id: The identifier of the resource. (required)
        :param Permissions document: Update a document by sending the paths to be updated in the request body. (required)
        :param str select: Select which paths will be returned by the query. [doc](https://github.com/wprl/baucis/wiki/Query-String-Parameters#select)
        :param str populate: Specify which paths to populate. [doc](https://github.com/wprl/baucis/wiki/Query-String-Parameters#populate)
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_permissions`")
        # verify the required parameter 'document' is set
        if ('document' not in params) or (params['document'] is None):
            raise ValueError("Missing the required parameter `document` when calling `update_permissions`")
