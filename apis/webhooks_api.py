...
class WebhooksApi(object):
    ...
    def create_webhooks(self, document, **kwargs):
        """
        Create some admin-webhooks
        Create one or more admin-webhooks.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_webhooks(document, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param Webhooks document: Create a document by sending the paths to be added in the request body. (required)
        ...
        if ('document' not in params) or (params['document'] is None):
            raise ValueError("Missing the required parameter `document` when calling `create_webhooks`")

        resource_path = '/admin-webhooks'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_webhooks_by_id(self, id, **kwargs):
        """
        Delete a _webhooks by its unique ID
        Deletes an existing _webhooks by its ID.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_webhooks_by_id(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_webhooks_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_webhooks_by_id`")

        resource_path = '/admin-webhooks/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
    ...
    def delete_webhooks_by_query(self, **kwargs):
        """
        Delete some admin-webhooks by query
        Delete all admin-webhooks matching the specified query.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_webhooks_by_query(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_webhooks_by_query" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        response = self.api_client.call_api(resource_path, 'DELETE',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[Webhooks]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_webhooks_by_id(self, id, **kwargs):
        """
        Get a _webhooks by its unique ID
        Retrieve a _webhooks by its ID.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_webhooks_by_id(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_webhooks_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_webhooks_by_id`")
    ...
    def query_webhooks(self, **kwargs):
        """
        Query some admin-webhooks
        Query over admin-webhooks.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.query_webhooks(callback=callback_function)
    ...
    def update_webhooks(self, id, document, **kwargs):
        """
        Modify a _webhooks by its unique ID
        Update an existing _webhooks by its ID.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_webhooks(id, document, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str id: The identifier of the resource. (required)
        :param Webhooks document: Update a document by sending the paths to be updated in the request body. (required)
        :param str select: Select which paths will be returned by the query. [doc](https://github.com/wprl/baucis/wiki/Query-String-Parameters#select)
        :param str populate: Specify which paths to populate. [doc](https://github.com/wprl/baucis/wiki/Query-String-Parameters#populate)
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_webhooks`")
        # verify the required parameter 'document' is set
        if ('document' not in params) or (params['document'] is None):
            raise ValueError("Missing the required parameter `document` when calling `update_webhooks`")
