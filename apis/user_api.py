...
class UserApi(object):
    ...
    def add_case_records_to_user(self, id, document, **kwargs):
        """
        Link CaseRecord(s).
        Link CaseRecord(s).
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_case_records_to_user(id, document, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method add_case_records_to_user" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `add_case_records_to_user`")
        # verify the required parameter 'document' is set
        if ('document' not in params) or (params['document'] is None):
            raise ValueError("Missing the required parameter `document` when calling `add_case_records_to_user`")

        resource_path = '/users/{id}/caseRecords'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
    ...
    def create_user(self, document, **kwargs):
        """
        Create some users
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_user(document, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param User document: Create a document by sending the paths to be added in the request body. (required)
        ...
        # verify the required parameter 'document' is set
        if ('document' not in params) or (params['document'] is None):
            raise ValueError("Missing the required parameter `document` when calling `create_user`")
    ...
    def delete_by_ids(self, document, **kwargs):
        ...
        resource_path = '/users/deleteByIds'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_user_by_query(self, **kwargs):
        """
        Delete some users by query
        Delete all users matching the specified query.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_user_by_query(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_user_by_query" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_user_case_records(self, id, **kwargs):
        """
        Retrieves the linked caseRecords.
        Retrieves the linked caseRecords.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_user_case_records(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_user_case_records" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_user_case_records`")
    ...
    def query_user(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.query_user(callback=callback_function)
    ...
    def update_user(self, id, document, **kwargs):
        """
        Modify a user by its unique ID
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_user(id, document, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str id: The identifier of the resource. (required)
        :param User document: Update a document by sending the paths to be updated in the request body. (required)
        :param str select: Select which paths will be returned by the query. [doc](https://github.com/wprl/baucis/wiki/Query-String-Parameters#select)
        :param str populate: Specify which paths to populate. [doc](https://github.com/wprl/baucis/wiki/Query-String-Parameters#populate)
        ...
        # verify the required parameter 'document' is set
        if ('document' not in params) or (params['document'] is None):
            raise ValueError("Missing the required parameter `document` when calling `update_user`")
