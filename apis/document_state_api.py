...
class DocumentStateApi(object):
    ...
    def set_document_state_document(self, id, document, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.set_document_state_document(id, document, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method set_document_state_document" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `set_document_state_document`")
        # verify the required parameter 'document' is set
        if ('document' not in params) or (params['document'] is None):
            raise ValueError("Missing the required parameter `document` when calling `set_document_state_document`")
    ...
    def unlink_case_record_from_document_state(self, id, case_record_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.unlink_case_record_from_document_state(id, case_record_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method unlink_case_record_from_document_state" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `unlink_case_record_from_document_state`")
        # verify the required parameter 'case_record_id' is set
        if ('case_record_id' not in params) or (params['case_record_id'] is None):
            raise ValueError("Missing the required parameter `case_record_id` when calling `unlink_case_record_from_document_state`")

        resource_path = '/documentStates/{id}/caseRecord/{caseRecordId}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def unlink_document_from_document_state(self, id, required_document_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.unlink_document_from_document_state(id, required_document_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method unlink_document_from_document_state" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `unlink_document_from_document_state`")
        ...
        if ('required_document_id' not in params) or (params['required_document_id'] is None):
            raise ValueError("Missing the required parameter `required_document_id` when calling `unlink_document_from_document_state`")

        resource_path = '/documentStates/{id}/document/{requiredDocumentId}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def update_document_state(self, id, document, **kwargs):
        """
        Modify a documentState by its unique ID
        Update an existing documentState by its ID.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_document_state(id, document, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str id: The identifier of the resource. (required)
        :param DocumentState document: Update a document by sending the paths to be updated in the request body. (required)
        :param str select: Select which paths will be returned by the query. [doc](https://github.com/wprl/baucis/wiki/Query-String-Parameters#select)
        :param str populate: Specify which paths to populate. [doc](https://github.com/wprl/baucis/wiki/Query-String-Parameters#populate)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_document_state" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_document_state`")
        # verify the required parameter 'document' is set
        if ('document' not in params) or (params['document'] is None):
            raise ValueError("Missing the required parameter `document` when calling `update_document_state`")
